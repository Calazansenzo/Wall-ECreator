...
from src.routes.projeto import projeto_bp
...
def serve(path):
    ...
    if path == 'add.html' or path == 'add':
        return send_from_directory(static_folder_path, 'add.html')
    elif path.startswith('view/'):
        return send_from_directory(static_folder_path, 'view.html')
